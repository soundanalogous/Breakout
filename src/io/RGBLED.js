/**
 * @author Jeff Hoefs
 * Based on RGBLED.as in Funnel AS3 library (funnel.cc) by Shigeru Kobayashi
 */
...
BREAKOUT.io.RGBLED = (function() {
	 ...
	 * common cathode RGBLED, connect the cathode to ground and the 3 anode pins 
	 * to the IOBoard PWM pins via 330 ohm resistors. For a common anode LED, the 
	 ...
	 * @param {Pin} greenLEDPin A reference to the IOBoard Pin the green led pin is connected to.
	 * @param {Pin} blueLEDPin A reference to the IOBoard Pin the blue led pin is connected to.	 
	 * @param {Number} driveMode The drive mode of the RGBLED. Must be set to RGBLED.COMMON_ANODE
	 * or RGBLED.COMMON_CATHODE. RGBLED.COMMON_ANODE is default.
	 */
