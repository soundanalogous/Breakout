...
BO.io.CompassHMC6352 = (function() {
	 ...
	 * Use the compass to obtain a heading. You must hold the sensor 
	 * flat to obtain the most accurate heading value (just like an
	 * analog compass). The compass is also useful in obtaining a
	 * rotation value in relation to a fixed position. 
	 * See Breakout/examples/sensors/hmc6352.html and
	 * Breakout/examples/processing_js/compass.html for example
	 * applications.
	 * @constructor
	 * @augments BO.I2CBase
	...
	/**
	 * The update event is dispatched when the compass heading is
	 * updated.
	 * @name CompassHMC6352#update
	 * @type BO.io.CompassEvent.UPDATE
	 * @event
	 * @param {BO.io.CompassHMC6352} target A reference to the
	 * CompassHMC6352 object.
	 */		
